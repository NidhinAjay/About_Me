import 'package:about_me/profile.dart';
        ...
        child: Column(
          ...
          children: [
            CircleAvatar(
              ...
              radius: 75,
              backgroundImage: AssetImage('images/nidhin.jpeg',),
            ),

            SizedBox(height: 20,),
            Text("Nidhin Ajay P",style:TextStyle(color:Colors.white,fontSize: 25)
              ,),
            SizedBox(height: 20,),
            ...
            Padding(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(shape: StadiumBorder(),backgroundColor:Colors.black26),
